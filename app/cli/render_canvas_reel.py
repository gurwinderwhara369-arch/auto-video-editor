...
from app.cli.render_reel import (
    infer_job_id,
    load_or_analyze_metadata,
    load_or_analyze_moments,
)
...
from app.engine.core.models import BeatMap, Effect, TemplateRecipe
                        ...
                        "effect": segment.effect.model_copy(
                            update={
                                "metadata": {
                                    ...
                                    **(
                                        {}
                                        if segment.visual_events
                                        else {"canvas_effect": CANVAS_EFFECTS[segment.segment_index % len(CANVAS_EFFECTS)]}
                                    ),
                                }
                            }
                        )
